...
| 文档 | 说明 |
|---|---|
| [00-通用安全与幂等规则.md](00-通用安全与幂等规则.md) | 鉴权、身份拦截、数据权限、幂等、防刷规则 |
...
| 方法 | 路径 | 说明 | 详细文档 |
|---|---|---|---|
| GET | `/user/home` | 用户首页，返回真实借阅统计 | [user/01-用户首页.md](user/01-用户首页.md) |
...
| GET | `/user/points-records/{pointsRecordId}` | 本人积分详情 | [user/06-查询积分详情.md](user/06-查询积分详情.md) |
