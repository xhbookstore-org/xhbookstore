...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '书城科技',   0, '书城', '15888888888', 'xhbookstore@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '深圳总公司', 1, '书城', '15888888888', 'xhbookstore@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(102,  100, '0,100',      '长沙分公司', 2, '书城', '15888888888', 'xhbookstore@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '研发部门',   1, '书城', '15888888888', 'xhbookstore@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(104,  101, '0,100,101',  '市场部门',   2, '书城', '15888888888', 'xhbookstore@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '测试部门',   3, '书城', '15888888888', 'xhbookstore@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(106,  101, '0,100,101',  '财务部门',   4, '书城', '15888888888', 'xhbookstore@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(107,  101, '0,100,101',  '运维部门',   5, '书城', '15888888888', 'xhbookstore@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(108,  102, '0,100,102',  '市场部门',   1, '书城', '15888888888', 'xhbookstore@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(109,  102, '0,100,102',  '财务部门',   2, '书城', '15888888888', 'xhbookstore@qq.com', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', '书城', '00', 'xhbookstore@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '管理员');
insert into sys_user values(2,  105, 'ry',    '书城', '00', 'xhbookstore@qq.com',  '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '测试员');
...
insert into sys_menu values('4', '书城官网', '0', '4', 'http://xhbookstore.com', null, '', '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', sysdate(), '', null, '书城官网地址');
-- 二级菜单
...
insert into sys_job values(1, '系统默认（无参）', 'DEFAULT', 'xhBookstoreTask.xhBookstoreNoParams',        '0/10 * * * * ?', '3', '1', '1', 'admin', sysdate(), '', null, '');
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒：2018-07-01 书城新版本发布啦', '2', '新版本内容', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('2', '维护通知：2018-07-01 书城系统凌晨维护', '1', '维护内容',   '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('3', '书城开源框架介绍', '1', '<p><span style=\"color: rgb(230, 0, 0);\">项目介绍</span></p><p><font color=\"#333333\">XhBookstore开源项目是为企业用户定制的后台脚手架框架，为企业打造的一站式解决方案，降低企业开发成本，提升开发效率。主要包括用户管理、角色管理、部门管理、菜单管理、参数管理、字典管理、</font><span style=\"color: rgb(51, 51, 51);\">岗位管理</span><span style=\"color: rgb(51, 51, 51);\">、定时任务</span><span style=\"color: rgb(51, 51, 51);\">、</span><span style=\"color: rgb(51, 51, 51);\">服务监控、登录日志、操作日志、代码生成等功能。其中，还支持多数据源、数据权限、国际化、Redis缓存、Docker部署、滑动验证码、第三方认证登录、分布式事务、</span><font color=\"#333333\">分布式文件存储</font><span style=\"color: rgb(51, 51, 51);\">、分库分表处理等技术特点。</span></p><p><img src=\"https://foruda.gitee.com/images/1773931848342439032/a4d22313_1815095.png\" style=\"width: 64px;\"><br></p><p><span style=\"color: rgb(230, 0, 0);\">官网及演示</span></p><p><span style=\"color: rgb(51, 51, 51);\">书城官网地址：&nbsp;</span><a href=\"http://xhbookstore.com\" target=\"_blank\">http://xhbookstore.com</a><a href=\"http://xhbookstore.com\" target=\"_blank\"></a></p><p><span style=\"color: rgb(51, 51, 51);\">书城文档地址：&nbsp;</span><a href=\"http://doc.xhbookstore.com\" target=\"_blank\">http://doc.xhbookstore.com</a><br></p><p><span style=\"color: rgb(51, 51, 51);\">演示地址【不分离版】：&nbsp;</span><a href=\"http://demo.xhbookstore.com\" target=\"_blank\">http://demo.xhbookstore.com</a></p><p><span style=\"color: rgb(51, 51, 51);\">演示地址【分离版本】：&nbsp;</span><a href=\"http://vue.xhbookstore.com\" target=\"_blank\">http://vue.xhbookstore.com</a></p><p><span style=\"color: rgb(51, 51, 51);\">演示地址【微服务版】：&nbsp;</span><a href=\"http://cloud.xhbookstore.com\" target=\"_blank\">http://cloud.xhbookstore.com</a></p><p><span style=\"color: rgb(51, 51, 51);\">演示地址【移动端版】：&nbsp;</span><a href=\"http://h5.xhbookstore.com\" target=\"_blank\">http://h5.xhbookstore.com</a></p><p><br style=\"color: rgb(48, 49, 51); font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; font-size: 12px;\"></p>', '0', 'admin', sysdate(), '', null, '管理员');
...
create table member_level (
  ...
  status          tinyint         default 0                  comment '状态：0-正常，1-停用',
  primary key (id)
) engine=innodb auto_increment=1 comment='会员等级表';

insert into member_level values (1, '普通会员', 1.00, 0);
...
create table member (
  ...
  card_type_id        int             default null               comment '卡类型ID，关联card_type表',
  level_id            int             default null               comment '会员等级ID，关联member_level表',
  dept_id             bigint(20)      default null               comment '所属部门ID，关联sys_dept表',
  valid_date          date            default null               comment '会员有效期',
  status              tinyint         default 0                  comment '状态：0-正常，1-删除',
  borrow_count_valid  int             default 0                  comment '可借阅数量',
  current_points      int             default 0                  comment '当前积分/书城币余额',
  remark              text            default null               comment '备注',
  last_operator       varchar(50)     default null               comment '最后操作人',
  source              varchar(20)     default 'manual'           comment '来源：manual-手动录入，import-批量导入',
  sync_erp            tinyint(1)      default 0                  comment '是否同步ERP：0-未同步，1-已同步',
...
create table member_ext (
  ...
  total_purchase_amount   decimal(10,2)   default 0.00               comment '累计消费金额',
  total_purchase_count    int             default 0                  comment '累计消费数量',
  total_purchase_times    int             default 0                  comment '累计消费次数',
  superior_name           varchar(50)     default null               comment '上级推荐人姓名',
  superior_points_ratio   decimal(5,2)    default null               comment '上级积分比例',
  business_staff_name     varchar(50)     default null               comment '业务员姓名',
  excel_raw_data          longtext        default null               comment '导入时的原始Excel数据',
  created_at              datetime        default current_timestamp  comment '创建时间',
  updated_at              datetime        default current_timestamp on update current_timestamp comment '修改时间',
  primary key (id),
  unique key uk_member_id (member_id)
) engine=innodb auto_increment=1 default charset=utf8mb4 comment='会员扩展信息表';
...
create table member_import_log (
  ...
  original_content  longtext        default null               comment '原始文件内容',
  error_log         text            default null               comment '错误日志',
  remark            varchar(255)    default null               comment '备注',
  created_at        datetime        default current_timestamp  comment '创建时间',
  primary key (id)
) engine=innodb auto_increment=1 default charset=utf8mb4 comment='会员导入日志表';

-- ----------------------------
-- 21.6 会员导入明细表
-- ----------------------------
drop table if exists member_import_detail;
create table member_import_detail (
  id                int             not null auto_increment    comment '主键',
  log_id            int             not null                   comment '导入日志ID，关联member_import_log表',
...
-- 22.1 书城币订单表
-- ----------------------------
drop table if exists xhbs_points_order;
...
-- 22.2 书城币入账待核销流水明细表
-- ----------------------------
drop table if exists xhbs_points_user_into_bill_detail;
...
-- 22.3 书城币出账待核销流水明细表
-- ----------------------------
drop table if exists xhbs_points_user_out_bill_detail;
...
-- 22.4 书城币核销明细表
-- ----------------------------
drop table if exists xhbs_points_user_bill_detail;
