  ...
  <div class="dashboard-page">
    <div class="dashboard-header">
      ...
      <div class="dashboard-actions">
        <el-select v-model="selectedDeptId" clearable placeholder="全部可见门店" size="small" @change="getOverview">
...
<script>
import { getMemberDashboardOverview, getMemberDashboardDepts, refreshMemberDashboard } from '@/api/dashboard'
...
export default {
  ...
  methods: {
    ...
    getDeptOptions() {
      getMemberDashboardDepts().then(res => {
